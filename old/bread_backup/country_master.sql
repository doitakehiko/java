...
select * from country_master where country_name_jp = 'test';
select * from country_code_master where country_master_id = 251;
delete from country_code_master where country_master_id = 251;
delete from country_master where country_name_jp = 'test';